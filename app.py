...
def make_grayscale(input_image):
    ...
    print("Decoded Value Of Image : ",decode_array_img)

    converted_gray=cv2.cvtColor(decode_array_img,cv2.COLOR_RGB2GRAY)
    status,output_image=cv2.imencode('.PNG',converted_gray)
    print("Status : ",status)
